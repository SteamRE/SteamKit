...
using SteamKitten.Util;
using SteamKitten.Util.MacHelpers;
using static SteamKitten.Util.MacHelpers.CoreFoundation;
using static SteamKitten.Util.MacHelpers.DiskArbitration;
using static SteamKitten.Util.MacHelpers.IOKit;
using static SteamKitten.Util.MacHelpers.LibC;
...
namespace SteamKitten
{
    ...
    sealed class DefaultMachineInfoProvider : IMachineInfoProvider
    {
        ...
        {
            return Encoding.UTF8.GetBytes( Environment.MachineName + "-SteamKitten" );
        }
        ...
        public byte[] GetMacAddress()
        {
            ...
            {
                // See: https://github.com/SteamRE/SteamKitten/issues/629
            }
            // well...
            return Encoding.UTF8.GetBytes( "SteamKitten-MacAddress" );
        }

        public byte[] GetDiskId()
        {
            return Encoding.UTF8.GetBytes( "SteamKitten-DiskId" );
        }

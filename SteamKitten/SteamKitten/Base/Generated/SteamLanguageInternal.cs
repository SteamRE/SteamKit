...
namespace SteamKitten.Internal
{
	...
	public class MsgHdrProtoBuf : ISteamSerializableHeader
	{
		...
		// Static size: 0
		public SteamKitten.Internal.CMsgProtoBufHeader Proto { get; set; }

		public MsgHdrProtoBuf()
		{
			Msg = EMsg.Invalid;
			HeaderLength = 0;
			Proto = new SteamKitten.Internal.CMsgProtoBufHeader();
		}

		public void Serialize(Stream stream)
		{
			using MemoryStream msProto = new MemoryStream();
			ProtoBuf.Serializer.Serialize<SteamKitten.Internal.CMsgProtoBufHeader>(msProto, Proto);
		...
		public void Deserialize( Stream stream )
		{
			...
			Proto = ProtoBuf.Serializer.Deserialize<SteamKitten.Internal.CMsgProtoBufHeader>( stream, length: HeaderLength );
		}
	}
	...
	public class MsgGCHdrProtoBuf : IGCSerializableHeader
	{
		...
		public int HeaderLength { get; set; }
		// Static size: 0
		public SteamKitten.GC.Internal.CMsgProtoBufHeader Proto { get; set; }

		public MsgGCHdrProtoBuf()
		{
			Msg = 0;
			HeaderLength = 0;
			Proto = new SteamKitten.GC.Internal.CMsgProtoBufHeader();
		}

		public void Serialize(Stream stream)
		{
			using MemoryStream msProto = new MemoryStream();
			ProtoBuf.Serializer.Serialize<SteamKitten.GC.Internal.CMsgProtoBufHeader>(msProto, Proto);
			HeaderLength = (int)msProto.Length;
			using BinaryWriter bw = new BinaryWriter( stream, Encoding.UTF8, leaveOpen: true );
		...
		public void Deserialize( Stream stream )
		{
			...
			HeaderLength = br.ReadInt32();
			ArgumentOutOfRangeException.ThrowIfNegative( HeaderLength );
			Proto = ProtoBuf.Serializer.Deserialize<SteamKitten.GC.Internal.CMsgProtoBufHeader>( stream, length: HeaderLength );
		}
	}

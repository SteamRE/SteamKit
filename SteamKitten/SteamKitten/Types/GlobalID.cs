...
namespace SteamKitten
{
    ...
    public class GlobalID : IEquatable<GlobalID>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SteamKitten.GlobalID"/> to <see cref="ulong"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="ulong"/> to <see cref="SteamKitten.GlobalID"/>.
        /// </summary>
        /// <param name="gid">The gid.</param>
        /// <returns>
        /// The result of the conversion.
    ...
    public sealed class UGCHandle : GlobalID
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SteamKitten.UGCHandle"/> to <see cref="ulong"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="ulong"/> to <see cref="SteamKitten.UGCHandle"/>.
        /// </summary>
        /// <param name="ugcId">The UGC ID.</param>
        /// <returns>
        /// The result of the conversion.

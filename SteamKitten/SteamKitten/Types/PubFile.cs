...
// warning CS0660: 'SteamKitten.UGCHandle' defines operator == or operator != but does not override Object.Equals(object o)
...
#pragma warning disable 0661
    ...
    public sealed class PublishedFileID : UInt64Handle
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SteamKitten.PublishedFileID"/> to <see cref="ulong"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="ulong"/> to <see cref="SteamKitten.PublishedFileID"/>.
        /// </summary>
        /// <param name="fileId">The file id.</param>
        /// <returns>
        /// The result of the conversion.

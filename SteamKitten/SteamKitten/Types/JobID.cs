...
namespace SteamKitten
{
    ...
    public class JobID : GlobalID
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SteamKitten.JobID"/> to <see cref="ulong"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="ulong"/> to <see cref="SteamKitten.JobID"/>.
        /// </summary>
        /// <param name="jobId">The Job ID.</param>
        /// <returns>
        /// The result of the conversion.

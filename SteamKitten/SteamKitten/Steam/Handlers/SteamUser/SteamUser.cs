...
namespace SteamKitten
{
    ...
    public sealed partial class SteamUser : ClientMsgHandler
    {
        ...
        public sealed class LogOnDetails
        {
            ...
            /// <seealso cref="SteamKitten.SteamID.DesktopInstance"/>
            /// <seealso cref="SteamKitten.SteamID.ConsoleInstance"/>
            ...
            public string? MachineName { get; set; } = $"{Environment.MachineName} (SteamKitten)";
            /// <summary>

...
namespace SteamKitten
{
    class UdpConnection : IConnection
    {
        ...
        /// <summary>
        /// Dispatches up to one message to the rest of SteamKitten
        /// </summary>
        ...
        /// <summary>
        /// Receives typical data packets before dispatching them for consumption by the rest of SteamKitten
        /// </summary>
        /// <param name="packet">The packet.</param>

...
namespace Classless.Hasher {
	...
	public class Sha224 : BlockHashAlgorithm {
		...
		override public void Initialize() {
			lock (syncLock) {
				base.Initialize();
				accumulator = new uint[] { 0xC1059ED8, 0x367CD507, 0x3070DD17, 0xF70E5939, 0xFFC00B31, 0x68581511, 0x64F98FA7, 0xBEFA4FA4 };
			}
		}
		...
		override protected byte[] ProcessFinalBlock(byte[] inputBuffer, int inputOffset, int inputCount) {
			lock (syncLock) {
				...
				return Conversions.UIntToByte(final, EndianType.BigEndian);
			}
		}

...
namespace Classless.Hasher {
	...
	public class SumSysV : HashAlgorithm {
		...
		override protected byte[] HashFinal() {
			lock (syncLock) {
				...
				checksum = (uint)((r & 0xFFFF) + (r >> 16));
				return Conversions.UShortToByte((ushort)(checksum & 0xFFFF), EndianType.BigEndian);
			}
		}
	}
}

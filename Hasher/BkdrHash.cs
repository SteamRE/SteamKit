...
namespace Classless.Hasher {
	/// <summary>Computes the BKDR Hash for the input data using the managed library.</summary>
	public class BkdrHash : HashAlgorithm {
		private readonly object syncLock = new object();

		private uint checksum;


		/// <summary>Initializes a new instance of the BkdrHash class.</summary>
		public BkdrHash () : base() {
			HashSizeValue = 32;
		}

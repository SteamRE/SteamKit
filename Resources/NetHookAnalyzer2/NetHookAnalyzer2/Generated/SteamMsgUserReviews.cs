...
namespace NetHookAnalyzer2.Protobufs
{
    ...
    public partial class RecommendationDetails : global::ProtoBuf.IExtensible
    {
        ...
        public int review_quality
        {
            get => __pbn__review_quality.GetValueOrDefault();
            set => __pbn__review_quality = value;
        }
        public bool ShouldSerializereview_quality() => __pbn__review_quality != null;
        public void Resetreview_quality() => __pbn__review_quality = null;
        private int? __pbn__review_quality;

...
..\..\Protogen\protogen -s:..\  -i:"dota_gcmessages_common.proto" -i:"dota_gcmessages_client.proto" -i:"dota_gcmessages_server.proto" -o:"..\..\..\SteamKit2\SteamKit2\Base\Generated\GC\Dota\MsgGC.cs" -t:csharp -ns:"SteamKit2.GC.Dota.Internal" -p:import="SteamKit2.GC.Internal"
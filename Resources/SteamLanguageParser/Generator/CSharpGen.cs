    ...
    class CSharpGen : ICodeGen
    {
        ...
        public void EmitNamespace(StringBuilder sb, bool end, string nspace)
        {
            if (end)
            {
                ...
                sb.AppendLine("#pragma warning restore CA1041");
            }
            else
            {
                sb.AppendLine("// <auto-generated/>");
                sb.AppendLine("#pragma warning disable CS1591"); // this will hide "Missing XML comment for publicly visible type or member 'Type_or_Member'"
                sb.AppendLine("#pragma warning disable CS0219"); // Warning CS0219: The variable `(variable)' is assigned but its value is never used
                sb.AppendLine("#pragma warning disable CA1041"); // CA1041: Provide ObsoleteAttribute message

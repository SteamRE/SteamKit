	...
	: Encrypt_Detour( NULL ), Decrypt_Detour( NULL )
{
	...
	bool bEncrypt = steamClientScan.FindFunction(
		"\x55\x8B\xEC\x64\xA1\x00\x00\x00\x00\x6A\xFF\x68\x00\x00\x00\x00\x50\x64\x89\x25\x00\x00\x00\x00\xA1\x00\x00\x00\x00"
		"\x8B\x08\x81\xEC\x00\x00\x00\x00\x85\xC9\x75\x08\x89\x4D\xEC\x88\x4D\xF0\xEB\x27\xE8\x00\x00\x00\x00\x8D\x55\xEC\x52"
		"\x6A\x04\x6A\x00\x68\x00\x00\x00\x00\x6A\x00\x68\x00\x00\x00\x00\x8B\xC8\x89\x45\xEC\xFF\x15\x00\x00\x00\x00\x88\x45"
		"\xF0\x53\x56\x57\x83\x7D\x08\x00",
		"xxxxx????xxx????xxxx????x????xxxx????xxxxxxxxxxxxx????xxxxxxxxx????xxx????xxxxxxx????xxxxxxxxxx",
		(void **)&pEncrypt
	);

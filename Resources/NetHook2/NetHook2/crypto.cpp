	...
	: Encrypt_Detour( NULL ), Decrypt_Detour( NULL )
{
	...
	bool bEncrypt = steamClientScan.FindFunction(
		"\x53\x8B\xDC\x83\xEC\x08\x83\xE4\xF0\x83\xC4\x04\x55\x8B\x6B\x04\x89\x6C\x24\x04\x8B\xEC\x64\xA1\x00\x00\x00\x00\x6A"
		"\xFF\x68\x00\x00\x00\x00\x50\x64\x89\x25\x00\x00\x00\x00",

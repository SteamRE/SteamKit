...
namespace Steam3Lib
{
    ...
    class UdpHeader : Serializable<UdpHeader>
    {
        ...
        public UInt32 SourceConnID;
        public UInt32 DestinationConnID;

        public UInt32 SequenceThis;
        public UInt32 SequenceAcked;

        public UInt32 PacketsInMsg;
        public UInt32 MsgStartSequence;

...
namespace SteamKit2
{
	...
	public class MsgClientPackageInfoRequest : ISteamSerializableMessage
	{
		public EMsg GetEMsg() { return EMsg.ClientPackageInfoRequest; }

		// Static size: 0
		public CMsgClientPackageInfoRequest Proto { get; set; }

		public MsgClientPackageInfoRequest()
		{
			Proto = new CMsgClientPackageInfoRequest();
		}

		public void Serialize(Stream stream)
		{
			ProtoBuf.Serializer.Serialize<CMsgClientPackageInfoRequest>(stream, Proto);
		}

		public void Deserialize( Stream stream )
		{
			Proto = ProtoBuf.Serializer.Deserialize<CMsgClientPackageInfoRequest>( stream );
		}
	}

	public class MsgClientPackageInfoResponse : ISteamSerializableMessage
	{
		public EMsg GetEMsg() { return EMsg.ClientPackageInfoResponse; }

		// Static size: 0
		public CMsgClientPackageInfoResponse Proto { get; set; }

		public MsgClientPackageInfoResponse()
		{
			Proto = new CMsgClientPackageInfoResponse();
		}

		public void Serialize(Stream stream)
		{
			ProtoBuf.Serializer.Serialize<CMsgClientPackageInfoResponse>(stream, Proto);
		}

		public void Deserialize( Stream stream )
		{
			Proto = ProtoBuf.Serializer.Deserialize<CMsgClientPackageInfoResponse>( stream );
		}
	}

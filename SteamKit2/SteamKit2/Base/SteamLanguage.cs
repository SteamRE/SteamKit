...
namespace SteamKit2
{
	...
	public class MsgHdrProtoBuf : ISteamSerializableHeader
	{
		...
		// Static size: 0
		public SteamKit2.CMsgProtoBufHeader Proto { get; set; }

		public MsgHdrProtoBuf()
		{
			Msg = EMsg.Invalid;
			HeaderLength = 0;
			Proto = new SteamKit2.CMsgProtoBufHeader();
		}

		public void Serialize(Stream stream)
		{
			MemoryStream msProto = new MemoryStream();
			ProtoBuf.Serializer.Serialize<SteamKit2.CMsgProtoBufHeader>(msProto, Proto);
		...
		public void Deserialize( Stream stream )
		{
			...
			using( MemoryStream msProto = new MemoryStream( br.ReadBytes( HeaderLength ) ) )
				Proto = ProtoBuf.Serializer.Deserialize<SteamKit2.CMsgProtoBufHeader>( msProto );
		}
	}
